...
//получение выпускаюших кафедр и формирование текста к выводу	
			...
			$content['fak_kaf']	=	'<b>Випускові кафедри:</b>'.$kv;
			if($c)
			$content['fak_kaf']	.=  '<b>Загальноосвітні кафедри:</b>'.$k;
		}
// поиск по мтт ид 
...
*/
			...
			//	print_r($url_info_osp);				
					$cnt_galuz = 0;			
					$sh_specz = '';
					$ech = '<p style="text-indent:20px">Факультет готує фахівців за ступенем <b>бакалавра</b>, освітньо-кваліфікаційним рівнем <b>спеціаліста</b> та ступенем <b>магістра</b> за&nbspнаступними галузями знань:</p>';
